  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">Beranda</a></h1>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#team">Alur Pengajuan</a></li>
          <li><a href="#facts">Registrasi</a></li>
          <li><a href="#contact">Kontak Kami</a></li>
          <li><a href="process/index.html">Login</a></li>
        </ul>
    ...
    <section id="facts" class="wow fadeIn">
      <div class="container">
        ...
        <div class="row contact-info ">
          <div class="col-md-4">
            <div class="panel panel-info  wow fadeInLeft">
          ...
          <div class="col-md-7  wow fadeInRight">
            <form class="form-horizontal" action="process/controller/simpanakun.php" method="POST">
