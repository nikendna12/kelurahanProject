<?php
  ...
  if(empty($_SESSION['username'])){
    ...
    ?>
<?php	
  $sql = mysql_query("SELECT * FROM casis 
                          WHERE noregis = '$_SESSION[noregis]' ");
...
<table width="700" border="0">
  <tr>
    <td colspan="9"><div align="center"><h2>Sekolah Menengah Atas</h2></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="9"><div align="right"><b>NO PENDAFTARAN :</b> <?php echo "<b>"; echo $r['noregis']; echo "</b>"; ?></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>:</td>
    <td colspan="7"><?php echo $r['nama_casis']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>E-mail</td>
    <td>:</td>
    <td colspan="7"><?php echo $r['email']; ?></td>
  </tr>
  <tr>
    <td colspan="9">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td>Nama Ayah</td>
    <td>:</td>
    <td colspan="7"><?php echo $r['nama_ayah']; ?></td>
  </tr>
  <tr>
    <td>Nama Ibu</td>
    <td>:</td>
    <td colspan="7"><?php echo $r['nama_ibu']; ?></td>
  </tr>
  <tr>
    <td>Alamat Orang Tua</td>
    <td>:</td>
    <td colspan="7"><?php echo $r['alamat_ortu']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Nama Wali</td>
    <td>:</td>
    <td colspan="7"><?php echo $r['nama_wali']; ?></td>
  </tr>
  <tr>
    <td>Alamat Wali</td>
    <td>:</td>
  ...
  <tr>
    ...
    <td colspan="5">&nbsp;</td>
    <td colspan="3"><?php echo $r['nama_casis']; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="5">&nbsp;</td>
