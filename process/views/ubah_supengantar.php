  ...
  <div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-sm-4">
          ...
          <form role="form" name="form1" action="../controller/unggah_supengantar.php" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="col-sm-12">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <?php
                      if ($r['supengantar']!=''){   
                        echo "<p align = center><img class='img-responsive' id='target' src='../dist/img/abc/$r[supengantar]' oncontextmenu='return false;'></p>";
                      } else {
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" id="src" name="fupload_supengantar" />
